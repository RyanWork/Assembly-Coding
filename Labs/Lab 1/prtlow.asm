...
;
	...
	cmp AL, "z"	; Compare the value of AL to 'z' character
	JA incPtr	; if the character is greater or above the ASCII code of 'z', jump to incPtr
	
	cmp AL, "a"	; Compare the value of AL to 'a' character
	JB incPtr	; If the character is less than or below the ASCII code of 'a', jump to incPtr
