...
; Print a negative sign
	mov AL, 2Dh		; ***FIX ME. Load the correct character to be printed into AL
...
; Print a carriage return, so that the next number is printed on a new line
	MOV AL, 0Dh		; ***FIX ME. Should load carriage return (CR) into AL
	out DX,AL		; print the CR
	MOV AL, 0Ah		; ***FIX ME. Should load line feed (LF) into AL
